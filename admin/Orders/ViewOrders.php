...
<div class="col-sm-12">
    ...
    <table class="table table-dark table-bordered">
        ...
        <tbody>
            <?php $data = getRows('orders');  $ind=1; ?>
            <?php foreach($data as $row){   ?>
            <tr class="text-center">
                <td scope="row"><?php echo $ind; ?></td>
                ...
                <?php
                    ...
                    $rowService = getRow('services','serve_id',$row['order_serve_id']);
                ?>
                <td class="text-center"><?php echo  $rowService['serve_name']; ?></td>
