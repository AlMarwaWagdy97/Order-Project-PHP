            ...
            <div class="row">
                ...
                if (isset($_POST['submit'])) 
                {
                    ...
                    if (Check_empty($mobile) && Check_empty($name)) 
                    {
                        ...
                        $sql  = "INSERT INTO orders (`order_name`,`order_email`,`order_mobile`,`order_serve_id`,`order_city_id`,`order_notes`)
                ...
                <form class="row" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="mt-5" >
                    ...
                    <div class="col-sm-6 ">
                        <div class="form-group mt-3">
                            ...
                            <select name="service" id="serv" class="form-control font-1">
                                ...
                                <option value="<?php echo $row['serve_id']; ?>">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <label for="serv" class="font-1">Name *</label>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group ">
                            ...
                            <label for="serv" class="font-1">Email</label>
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="form-group ">
                            ...
                            <label for="serv" class="font-1">Mobile *</label>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <label for="serv" class="font-1">Notes</label>
